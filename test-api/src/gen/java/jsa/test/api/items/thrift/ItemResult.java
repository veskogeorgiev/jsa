 ...
 *  @generated
 */
package jsa.test.api.items.thrift;
...
public class ItemResult implements org.apache.thrift.TBase<ItemResult, ItemResult._Fields>, java.io.Serializable, Cloneable, Comparable<ItemResult> {
	private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ItemResult");
	...
	static {
		schemes.put(StandardScheme.class, new ItemResultStandardSchemeFactory());
		schemes.put(TupleScheme.class, new ItemResultTupleSchemeFactory());
	}
	...
	static {
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ItemResult.class, metaDataMap);
	}
	 ...
	 */
	public ItemResult(ItemResult other) {
		if (other.isSetName()) {
	...
	public boolean equals(Object that) {
		if (that == null)
			return false;
		if (that instanceof ItemResult)
			return this.equals((ItemResult) that);
		return false;
	}

	public boolean equals(ItemResult that) {
		if (that == null)
			return false;
	...
	private static class ItemResultStandardSchemeFactory implements SchemeFactory {
		public ItemResultStandardScheme getScheme() {
			return new ItemResultStandardScheme();
		}
	}

	private static class ItemResultStandardScheme extends StandardScheme<ItemResult> {

		public void read(org.apache.thrift.protocol.TProtocol iprot, ItemResult struct) throws org.apache.thrift.TException {
		...
		public void write(org.apache.thrift.protocol.TProtocol oprot, ItemResult struct) throws org.apache.thrift.TException {
			struct.validate();
	...
	private static class ItemResultTupleSchemeFactory implements SchemeFactory {
		public ItemResultTupleScheme getScheme() {
			return new ItemResultTupleScheme();
		}
	}

	private static class ItemResultTupleScheme extends TupleScheme<ItemResult> {

		@Override
		public void write(org.apache.thrift.protocol.TProtocol prot, ItemResult struct) throws org.apache.thrift.TException {
		...
		@Override
		public void read(org.apache.thrift.protocol.TProtocol prot, ItemResult struct) throws org.apache.thrift.TException {
