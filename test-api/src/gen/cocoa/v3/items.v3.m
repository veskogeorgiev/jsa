...
@implementation v3items.v3Constants
+ (void) initialize {
}
@end

@interface v3availableItems_args : NSObject <TBase, NSCoding> {
}
...
@implementation v3availableItems_args
...
@interface v3AvailableItems_result : NSObject <TBase, NSCoding> {
...
@implementation v3AvailableItems_result
    ...
    switch (fieldID)
    {
      case 0:
        if (fieldType == TType_LIST) {
          ...
          {
            v3Item *_elem2 = [[v3Item alloc] init];
...
@interface v3saveItem_args : NSObject <TBase, NSCoding> {
  NSString * __arg1;
  int32_t __arg2;
  NSString * __arg3;
...
@implementation v3saveItem_args
...
@interface v3SaveItem_result : NSObject <TBase, NSCoding> {
}
...
@implementation v3SaveItem_result
...
@implementation v3ItemsAPIClient
...
- (NSMutableArray *) recv_availableItems
{
  ...
  v3AvailableItems_result * result = [[[v3AvailableItems_result alloc] init] autorelease_stub];
...
- (void) recv_saveItem
{
  ...
  v3SaveItem_result * result = [[[v3SaveItem_result alloc] init] autorelease_stub];
  [result read: inProtocol];
  [inProtocol readMessageEnd];
  return;
}
...
@implementation v3ItemsAPIProcessor
...
{
  v3availableItems_args * args = [[v3availableItems_args alloc] init];
  [args read: inProtocol];
  [inProtocol readMessageEnd];
  v3AvailableItems_result * result = [[v3AvailableItems_result alloc] init];
...
{
  v3saveItem_args * args = [[v3saveItem_args alloc] init];
  [args read: inProtocol];
  [inProtocol readMessageEnd];
  v3SaveItem_result * result = [[v3SaveItem_result alloc] init];
